...
### Админ панел – `admin-panel.html`
Новата страница `admin-panel.html` позволява настройка на папките и видимостта на бутоните. Отваря се чрез бутона **Admin** в `index.html` и записва промените чрез `saveConfig()`. Достъп имат само имейлите, записани в `adminEmails`.

За удобство е активиран потребител с име `admin` и парола `admin`, чрез който бутонът **Admin** става видим.
